...
class DataSet(object):
  ...
  def __init__(self,
    ...
    self.perm = numpy.arange(self._num_examples)
  ...
  def get_images(self, inds):
    return self._images[inds], self._labels[inds]
  ...
  def next_batch(self, batch_size, doperm=True):
    ...
    if doperm:
        return self._images[self.perm[start:end]], self._labels[self.perm[start:end]], self.perm[start:end]
    else:
        return self._images[start:end], self._labels[start:end], range(start,end+1)
